              ...
              <div style={{ display: 'flex', padding: '12px 0px' }}>         
                ...
                <div style={{ width: '67%', border: 'none', textAlign: 'left', lineHeight: '1.4' }}>           
                  <span style={{ fontSize: '18px' }}>
                    <a href="https://coinmarketcap.com/currencies/melo/?utm_medium=widget&amp;utm_campaign=cmcwidget&amp;utm_source=www.tokenmarketcap.org&amp;utm_content=melo" target="_blank" rel="noopener" style={{ textDecoration: 'none', color: 'rgb(16, 112, 224)'  }}>
                      Melo Inu (MELO)
                    </a>
                  </span>
                  <br />             
                                                     ...
                                                     <div style={{textAlign: 'center' , float: 'left' , width: '33%' , fontSize: '12px' , padding: '12px 0 16px 0' , lineHeight: '1em' }}> VOLUME
                                                      <br>
                                                        ...
                                                        <div style={{ borderTop: '1px solid #e1e5ea' , textAlign: 'center' , clear: 'both' , fontSize: '12px' , fontStyle: 'italic' , padding: '8px 0' }}>   
                                                         <a href="https://coinmarketcap.com?utm_medium=widget&amp;utm_campaign=cmcwidget&amp;utm_source=www.tokenmarketcap.org&amp;utm_content=melo" target="_blank" rel="noopener"
